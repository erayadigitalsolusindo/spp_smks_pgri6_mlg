...
Route::group(['middleware' => ['jwt.cookie']], function () {
    ...
    Route::prefix('spp')->group(function () {
        ...
        Route::get('tagihan_non_bulanan', [SppController::class,"daftar_tagihan_dinamis"])->name('spp.daftar_tagihan_dinamis');
        Route::get('form_tagihan', [SppController::class,"form_tagihan"])->name('spp.form_tagihan');
        Route::get('form_non_bulanan', [SppController::class,"form_tagihan_dinamis"])->name('spp.form_tagihan_non_bulanan');
