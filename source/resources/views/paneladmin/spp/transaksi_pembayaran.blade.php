...
<div class="row default-dashboard">
    ...
    <div class="card">
        ...
        <div class="card-body">
                ...
                <div class="card">
                    ...
                    <div class="card-body live-meet">
                        <div class="row">
                            ...
                            <div class="col-8">
                                : <span id="nomor_induk_siswa_temp"></span><br>
                                : <span id="nama_siswa_temp"></span><br>
                                : <span id="jenis_kelamin_temp"></span><br>
                                : <span id="alamat_temp"></span><br>
                                : <span id="no_telepon_temp"></span><br>
                                : <span id="email_temp"></span><br>
                                : <span id="kelas_temp"></span><br> 
                                : <span id="tahun_ajaran_temp"></span><br>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <button class="btn btn-success w-100 btn-lg" style="font-size: 22px;" id="btnTambahJenisPembayaranTransaksiSPP"><i class="fa fa-cart-plus"></i> Masukan Keranjang</button>
            </div>
            <div class="col-md-12">
                <div class="card-wrapper border rounded-3 h-100 checkbox-checked">
                    <h6 class="sub-title">Pilih Bulan Pembayaran</h6>
            ...
            <button class="btn btn-success w-100 btn-lg mt-2"  id="btnKonfirmasiTransaksiSPP"></i> Konfirmasi Transaksi</button>
        </div>
      </div>
    </div>
</div>
<div class="row">
    ...
    <div class="card">
        <div class="card-header">
          <h4>Tabel Riwayat Pembayaran</h4><span>Berikut adalah riwayat pembayaran siswa yang sudah dilakukan oleh siswa yang terdaftar, anda dapat mengelola data tersebut entah merubah dan menghapus data tersebut. Harap berhati-hati dalam menghapus dan mengubah data, karena jika data sudah terlanjur dihapus maka data tersebut tidak dapat dikembalikan lagi.</span>
        </div>
        <div class="card-body">
          <div class="col-md-12">
            <input type="text" class="form-control" id="kotak_pencarian_transaksi_pembayaran" placeholder="Cari data berdasarkan nama kelas yang tersedia">
            <div class="table">
              <table class="display" id="datatables_transaksi_pembayaran"></table>
            </div>
          </div>
        </div>
      </div>
